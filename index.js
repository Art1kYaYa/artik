...
bot.onText(/\/start/, (msg) => {
  ...
  const message = `Привет! Добро пожаловать в бота! Используйте встроенную клавиатуру ниже для выбора команды. Кстати открылся маркетплейс для покупки/продажи ресурсов. Подробнее https://t.me/c/2183539515/218`;
